...
public class ActivityLoaderActivity extends Activity {
	...
	private void startImplicitActivation() {
		...
		Intent bIntent = new Intent(Intent.ACTION_VIEW, url);
		...
		Intent chooserIntent = Intent.createChooser(bIntent, CHOOSER_TEXT);
...
//		startActivity(chooserIntent);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(requestCode == GET_TEXT_REQUEST_CODE && resultCode==RESULT_OK){
				...
				mUserTextView.setText(data.getExtras().getString("mydata"));
